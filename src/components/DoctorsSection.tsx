...
export default function DoctorsSection() {
  ...
  return (
    <section className="w-full bg-bg-cream h-auto lg:h-screen lg:overflow-hidden flex flex-col justify-center py-16 lg:py-10 px-4 sm:px-8 md:px-12 border-t border-divider">
      <div className="w-full max-w-[1400px] mx-auto flex flex-col h-full">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-4 gap-8 lg:gap-6 w-full lg:flex-1 lg:min-h-0 lg:overflow-visible lg:hide-scrollbar pb-4 lg:pb-0">
          {doctors.map((d, index) => (
            <div key={index} className="w-full h-auto lg:h-full flex flex-col group cursor-pointer gap-4">
              ...
              <div className="w-full h-[400px] sm:h-[500px] lg:flex-1 lg:min-h-[200px] rounded-[32px] bg-bg-beige border border-divider shadow-[0_4px_20px_rgba(47,93,80,0.03)] group-hover:shadow-[0_20px_50px_rgba(47,93,80,0.12)] transition-all duration-500 relative overflow-hidden group-hover:-translate-y-1.5">
                ...
                <div className="absolute inset-0 border border-brand-teal/0 group-hover:border-brand-teal/20 rounded-[32px] transition-all duration-500"></div>
              </div>
              ...
              <div className="flex flex-col text-center sm:text-left shrink-0 pb-2">
                ...
                <div className="w-10 h-[2px] bg-brand-teal/20 mx-auto sm:mx-0 mt-3 mb-2 transition-all group-hover:w-20 group-hover:bg-brand-teal/40"></div>
        ...
        <div className="flex justify-center shrink-0 mt-6 lg:mt-8 pt-4 border-t border-divider/50 mb-auto md:mb-0">
          <button className="w-full sm:w-auto font-sans text-xs sm:text-sm tracking-widest font-bold uppercase px-10 py-4 rounded-full bg-brand-dark text-white hover:bg-brand-teal transition-all shadow-md hover:shadow-lg active:scale-95 border border-transparent">
